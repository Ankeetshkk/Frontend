...
var AppComponent = /** @class */ (function () {
    function AppComponent(location, spinnerService) {
    ...
    AppComponent.prototype.isReport = function () {
...
var routing = _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forRoot([
    {
        path: '',
        pathMatch: 'full',
        redirectTo: '/assets'
...
var AssetEditorComponent = /** @class */ (function () {
    function AssetEditorComponent(route, router, assetService, deviceService, toasterService) {
        this.route = route;
        this.router = router;
    ...
    AssetEditorComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.isAlive = true;
        this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeWhile"])(function () { return _this.isAlive; }))
            .subscribe(function (params) {
            var id = params['id'];
            if (id) {
                _this.isEditable = true;
                _this.assetService.getAsset(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeWhile"])(function () { return _this.isAlive; }))
                    .subscribe(function (asset) {
                    _this.asset = asset;
                    _this.assetProperties = _this.asset.assetProperties;
                });
            }
        });
        this.deviceService.getDevices().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeWhile"])(function () { return _this.isAlive; }))
            .subscribe(function (devices) { return _this.devices = devices; });
    };
    AssetEditorComponent.prototype.ngOnDestroy = function () {
        this.isAlive = false;
    };
    AssetEditorComponent.prototype.submit = function () {
        var _this = this;
        ...
        if (this.isEditable) {
            this.assetService.updateAsset(this.asset)
                .subscribe(function () { return _this.router.navigate(['/assets']); });
        }
        else {
            this.assetService.addAsset(this.asset)
                .subscribe(function () { return _this.router.navigate(['/assets']); }, function (error) {
                _this.toasterService.pop('error', 'Invalid Input', 'Asset ID already exists');
            });
        }
    };
    AssetEditorComponent.prototype.deleteAsset = function () {
        var _this = this;
        this.assetService.deleteAsset(this.asset)
            .subscribe(function () { return _this.router.navigate(['/assets']); });
    };
    AssetEditorComponent.ctorParameters = function () { return [
...
var AssetListComponent = /** @class */ (function () {
    function AssetListComponent(assetService, locationService, mapsService, toasterService) {
        this.assetService = assetService;
    ...
    AssetListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.assetService.getAssets().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeWhile"])(function () { return _this.isAlive; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["skipWhile"])(function (assets) { return assets.length === 0; }))
            .subscribe(function (assets) {
            _this.assetsList = assets.sort(function (a, b) {
                if (a.name < b.name) {
                    return -1;
                }
                if (a.name > b.name) {
    ...
    AssetListComponent.prototype.ngOnDestroy = function () {
        this.isAlive = false;
        this.unsubscribe();
    };
    AssetListComponent.prototype.showPoints = function (asset, filterSelected) {
        var _this = this;
        if (filterSelected === void 0) { filterSelected = false; }
        ...
        if (asset === this.selectedAsset && this.isAssetPointsSelected() && !filterSelected) {
            ...
            this.subscription = this.assetService.getPoints(asset.id, this.selectedDateRange)
                ...
                _this.mapsService.showPoints(points);
            });
        }
    };
    AssetListComponent.prototype.showAsset = function (asset) {
    ...
    AssetListComponent.prototype.showAllAssets = function () {
        var _this = this;
        this.unsubscribe();
        this.subscription = this.assetService.getLatestPoints()
            .subscribe(function (points) {
            _this.mapsService.showAssetsPositions(points);
            if (_this.selectedAsset && !points[_this.selectedAsset.name]) {
                _this.toasterService.pop('error', '', 'Can\'t find position of ' + _this.selectedAsset.name);
            }
            else if (_this.selectedAsset) {
                _this.mapsService.showAsset([_this.selectedAsset, points[_this.selectedAsset.name]]);
            }
        });
    };
    AssetListComponent.prototype.showTrips = function (asset, filterSelected) {
        var _this = this;
        if (filterSelected === void 0) { filterSelected = false; }
        ...
        if (asset === this.selectedAsset && this.isAssetTripsSelected() && !filterSelected) {
            ...
            this.subscription = this.assetService.getTrips(asset.id, this.selectedDateRange)
                ...
                _this.trips = trips;
                _this.mapsService.showTrips(trips);
            });
        }
    };
    AssetListComponent.prototype.selectTrip = function (trip) {
        this.mapsService.showTrip(trip);
        this.isDrawing = true;
    };
    AssetListComponent.prototype.timeFilterChange = function (range) {
        if (this.lastCalledFunction) {
            this.selectedDateRange = range;
            this.lastCalledFunction(this.selectedAsset, true);
        }
    };
    AssetListComponent.prototype.unsubscribe = function () {
    ...
    AssetListComponent.prototype.isAssetListSeleceted = function () {
        return this.selectedAssetState === SelectedAssetState.ListSelected;
    };
    AssetListComponent.prototype.isAssetTripsSelected = function () {
        return this.selectedAssetState === SelectedAssetState.TripsSelected;
    };
    AssetListComponent.prototype.isAssetPointsSelected = function () {
...
var AssetService = /** @class */ (function () {
    function AssetService(dataService) {
    ...
    AssetService.prototype.getPoints = function (id, dateRange) {
        return this.dataService.get("assets/" + id + "/points").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (points) {
            if (!dateRange) {
                return points;
            }
            return points.filter(function (p) { return p.time >= +dateRange.from && p.time <= +dateRange.to; });
        }));
    };
    AssetService.prototype.getLatestPoints = function () {
        var _this = this;
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["interval"])(3 * 1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["startWith"])(0), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["flatMap"])(function () {
            return _this.dataService.getSingleNoCache("assets/all/positions");
        }));
    };
    AssetService.prototype.getTrips = function (id, dateRange) {
        return this.dataService.get("assets/" + id + "/trips").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (trips) {
            if (!dateRange) {
                return trips;
            }
...
var AuthorizedHttpService = /** @class */ (function () {
    function AuthorizedHttpService(http, toasterService) {
        this.http = http;
        this.toasterService = toasterService;
    }
    AuthorizedHttpService.prototype.get = function (path) {
        var _this = this;
        var subject = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        this.http.get(path, { withCredentials: true })
            .subscribe(function (data) { return subject.next(data); }, function (error) {
            _this.authErrorHandler(error);
            subject.error(error);
        });
        return subject.asObservable();
    };
    AuthorizedHttpService.prototype.put = function (path, dataToUse) {
        var _this = this;
        var subject = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
    ...
    AuthorizedHttpService.prototype.post = function (path, dataToUse) {
        var _this = this;
        var subject = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
    ...
    AuthorizedHttpService.prototype.delete = function (path) {
        var _this = this;
        var subject = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
    ...
    AuthorizedHttpService.prototype.authErrorHandler = function (error) {
        if (error.status === 401) {
    ...
    AuthorizedHttpService.ctorParameters = function () { return [
...
var Cache = /** @class */ (function () {
    ...
    Cache.prototype.getItems = function () {
    ...
    Cache.prototype.update = function (item) {
...
var DataService = /** @class */ (function () {
    function DataService(environmentSettingsService, authHttpService, spinnerService) {
    ...
    DataService.prototype.get = function (path) {
        ...
        this.authHttpService.get(url).subscribe(function (data) {
            cache.set(data);
            _this.spinnerService.stop();
        }, function (error) { return _this.spinnerService.stop(); });
        return cache.getItems();
    };
    DataService.prototype.getNoCache = function (path) {
        var url = this.getUrl(path);
        var observable = this.authHttpService.get(url);
        return observable;
    };
    DataService.prototype.getSingleNoCache = function (path) {
        var url = this.getUrl(path);
        var observable = this.authHttpService.get(url);
        return observable;
    };
    DataService.prototype.getSingle = function (path, id) {
        var cache = this.getCache(path);
        var url = this.getUrl(path, id);
        var subject = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"](cache.get(id));
        this.authHttpService.get(url)
            .subscribe(function (data) { cache.update(data); subject.next(data); }, function (error) { return subject.error(error); });
        return subject.asObservable();
    };
    DataService.prototype.post = function (path, data, queryParameters) {
        ...
        var observable = this.authHttpService.post(url, data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) { return typeof response != undefined ? response : null; }));
        observable
            .subscribe(function (d) { return cache.add(d); }, function (error) { });
        return observable;
    };
    DataService.prototype.put = function (path, id, data, updateAll) {
        var _this = this;
        var cache = this.getCache(path);
        var url = this.getUrl(path, id);
        var observable = this.authHttpService.put(url, data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) { return typeof response != undefined ? response : null; }));
        observable
    ...
    DataService.prototype.delete = function (path, id) {
        var _this = this;
        var cache = this.getCache(path);
        var url = this.getUrl(path, id);
        var observable = this.authHttpService.delete(url);
        observable
            .subscribe(function (d) { return _this.get(path); });
        return observable;
    };
    DataService.prototype.getUrl = function (path, id) {
        var url = this.environmentSettingsService.getEnvironmentVariable(_environment_settings_service__WEBPACK_IMPORTED_MODULE_6__["EnvironmentSettings"].backendUrl) + "/" + path;
        return id ? url + "/" + id : url;
    };
    DataService.prototype.getCache = function (path) {
...
var EnvironmentSettingsService = /** @class */ (function () {
    function EnvironmentSettingsService() {
    }
    EnvironmentSettingsService.prototype.getEnvironmentVariable = function (key) {
...
var NavComponent = /** @class */ (function () {
    ...
    NavComponent.prototype.onToggle = function () {
...
var SettingsService = /** @class */ (function () {
    ...
    SettingsService.prototype.getSubscriptionKeys = function () {
        return this.dataService.get('settings/subscriptionkeys');
    };
    SettingsService.prototype.getSubscriptionKey = function (key) {
        return this.dataService
            .getNoCache('settings/subscriptionkeys').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (results) { return results[key.toString()]; }));
    };
    SettingsService.prototype.getVersionInfo = function () {
        return this.dataService.getSingleNoCache("settings/version");
    };
    SettingsService.prototype.getInstrumentationApproval = function () {
        return this.dataService.getSingleNoCache("settings/instrumentation");
    };
    SettingsService.prototype.setInstrumentationApproval = function (approval) {
...
var SettingsComponent = /** @class */ (function () {
    function SettingsComponent(settingsService, dialog) {
    ...
    SettingsComponent.prototype.ngOnInit = function () {
        ...
        this.settingsService.getVersionInfo().subscribe(function (v) { return _this.versionInfo = v; });
        this.settingsService.getInstrumentationApproval().subscribe(function (a) { return _this.instrumentationState = a; });
    };
    SettingsComponent.prototype.toggleInstrumentation = function () {
        var _this = this;
        if (!this.instrumentationState) {
            this.dialog.open(_users_instrumentation_approval_instrumentation_approval_component__WEBPACK_IMPORTED_MODULE_4__["InstrumentationApprovalComponent"], {
                ...
                if (res != null) {
                    _this.settingsService.setInstrumentationApproval(res);
                    _this.instrumentationState = res;
                }
            });
        }
        else {
            this.settingsService.setInstrumentationApproval(false)
                .subscribe(function () { return _this.instrumentationState = false; });
        }
    };
...
var TripService = /** @class */ (function () {
    function TripService(dataService) {
        this.dataService = dataService;
    }
    TripService.prototype.getPoints = function (tripId, latitude, longitude) {
...
var DeviceEditorComponent = /** @class */ (function () {
    function DeviceEditorComponent(route, router, assetService, deviceService, toasterService, dialog) {
        this.route = route;
        this.router = router;
        this.assetService = assetService;
        this.deviceService = deviceService;
    ...
    DeviceEditorComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.routerSubscription = this.route.params.subscribe(function (params) {
            var id = params['id'];
            if (id) {
                _this.isEditing = true;
                _this.deviceSubscription = _this.deviceService.getDevice(id).subscribe(function (device) { return _this.device = device; });
                _this.deviceService.getToken(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["take"])(1)).subscribe(function (t) { return _this.deviceToken = t; });
            }
            else {
                // Work around for the fact that angular doesnt see this in change detection
                setTimeout(function () { return _this.openDialog(); }, 0);
            }
        });
        ...
        this.hubConnection = new _aspnet_signalr__WEBPACK_IMPORTED_MODULE_4__["HubConnectionBuilder"]()
            ...
            .build();
        this.hubConnection.on('DeviceAdded', function (data) {
            if (data === _this.nonce) {
    ...
    DeviceEditorComponent.prototype.ngOnDestroy = function () {
    ...
    DeviceEditorComponent.prototype.submit = function () {
        var _this = this;
        if (this.isEditing) {
            this.deviceService.updateDevice(this.device)
                .subscribe(function () { return _this.router.navigate(['/devices']); });
        }
        else {
            this.deviceService.addDevice(this.device)
                .subscribe(function () { return _this.router.navigate(['/devices']); }, function (error) {
                _this.toasterService.pop('error', 'Invalid Input', error._body);
            });
        }
    };
    DeviceEditorComponent.prototype.openDialog = function () {
    ...
    DeviceEditorComponent.prototype.deleteDevice = function () {
        var _this = this;
        this.deviceService.deleteDevice(this.device)
            .subscribe(function () { return _this.router.navigate(['/devices']); });
    };
    DeviceEditorComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] },
...
var DeviceListComponent = /** @class */ (function () {
    function DeviceListComponent(deviceService, mapsService, toasterService) {
        this.deviceService = deviceService;
        this.mapsService = mapsService;
        this.toasterService = toasterService;
        this.Roles = _shared_role__WEBPACK_IMPORTED_MODULE_4__["Roles"];
    ...
    DeviceListComponent.prototype.showAllDevices = function () {
        var _this = this;
        this.subscription = this.deviceService.getLatestPoints()
            ...
            var map = new Map();
            try {
                for (var _b = __values(Object.keys(points)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var key = _c.value;
            ...
            _this.mapsService.showDevicesPositions(map);
            if (_this.selectedDevice && !points[_this.selectedDevice.name]) {
                _this.toasterService.pop('error', '', 'Can\'t find position of ' + _this.selectedDevice.name);
            }
            else if (_this.selectedDevice) {
                _this.mapsService.showDevice([_this.selectedDevice.name, points[_this.selectedDevice.name]]);
            }
        });
    };
    DeviceListComponent.prototype.showDevice = function (device) {
    ...
    DeviceListComponent.prototype.showPoints = function (device, filterSelcted) {
        var _this = this;
        if (filterSelcted === void 0) { filterSelcted = false; }
        if (device === this.selectedDevice && this.isDevicePointSelected() && !filterSelcted) {
            ...
            this.subscription = this.deviceService.getPoints(device.id, this.selectedDateRange)
                .subscribe(function (points) { return _this.mapsService.showPoints(points); });
        }
    };
    DeviceListComponent.prototype.timeFilterChange = function (range) {
        this.selectedDateRange = range;
        this.showPoints(this.selectedDevice, true);
    };
    DeviceListComponent.prototype.unsubscribe = function () {
        if (this.subscription && !this.subscription.closed) {
            this.subscription.unsubscribe();
        }
    };
    DeviceListComponent.prototype.isDeviceListSelected = function () {
        return this.selctedDeviceState === SelectedDeviceState.ListSelected;
    };
    DeviceListComponent.prototype.isDevicePointSelected = function () {
...
var DeviceRegisterComponent = /** @class */ (function () {
    function DeviceRegisterComponent(data) {
        this.data = data;
        this.qrCodeEndpoint = '';
        this.qrCodeEndpoint = data;
    }
    DeviceRegisterComponent.ctorParameters = function () { return [
...
var DeviceService = /** @class */ (function () {
    ...
    DeviceService.prototype.getToken = function (id) {
        return this.dataService.post("devices/" + id + "/token", '');
    };
    DeviceService.prototype.getPoints = function (id, dateRange) {
        return this.dataService.get("devices/" + id + "/points").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (points) {
            if (!dateRange) {
                return points;
            }
            return points.filter(function (p) { return p.time >= +dateRange.from && p.time <= +dateRange.to; });
    ...
    DeviceService.prototype.getLatestPoints = function () {
        var _this = this;
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["interval"])(3 * 1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["startWith"])(0), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["flatMap"])(function () {
            return _this.dataService.getSingleNoCache("devices/all/positions");
        }));
    };
    ...
    DeviceService.prototype.getProvisioningQrCodeUrl = function (nonce) {
    ...
    DeviceService.prototype.getDeviceAdditionNotificationUrl = function () {
...
var DialogService = /** @class */ (function () {
    function DialogService(dialog, locationService) {
        this.dialog = dialog;
        this.locationService = locationService;
    }
    DialogService.prototype.showLocationsDialog = function () {
        var dialogRef;
...
var DispatchingEditorComponent = /** @class */ (function () {
    function DispatchingEditorComponent(assetService, dialogService, dispatchingService, locationService, mapsService, toasterService) {
        this.assetService = assetService;
    ...
    DispatchingEditorComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.isAlive = true;
        this.mapsService.getDispatchingPinsResult().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeWhile"])(function () { return _this.isAlive; }))
            .subscribe(function (result) {
            if (result.length) {
                _this.pinsAdded = result;
            }
        });
        this.assetService.getAssets().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeWhile"])(function () { return _this.isAlive; }))
            .subscribe(function (assets) {
            if (!_this.assets && assets.length) {
                _this.assets = assets;
            }
        });
        this.assetService.getLatestPoints().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeWhile"])(function () { return _this.isAlive; }))
            .subscribe(function (points) {
            _this.mapsService.showAssetsPositions(points, true);
        });
    };
    DispatchingEditorComponent.prototype.ngOnDestroy = function () {
        this.mapsService.endCurrentDraw();
        this.isAlive = false;
    };
    DispatchingEditorComponent.prototype.openDialog = function () {
        var _this = this;
        this.dialogService.showLocationsDialog()
            .subscribe(function (location) {
            if (location) {
                location.name = location.name + ("(" + (_this.pinsAdded.length + 1) + ")");
                _this.pinsAdded.push(location);
                _this.mapsService.resetDispatchingDraw(_this.pinsAdded);
            }
        });
    };
    DispatchingEditorComponent.prototype.checkSelected = function (asset) {
        this.showTruckOptions = asset.assetType === _assets_asset__WEBPACK_IMPORTED_MODULE_7__["AssetType"].Truck;
    };
    DispatchingEditorComponent.prototype.clearPoints = function () {
        this.pinsAdded = new Array();
        this.mapsService.resetDispatchingDraw();
    };
    DispatchingEditorComponent.prototype.showRoute = function () {
    ...
    DispatchingEditorComponent.prototype.onCheckChanged = function (event, Options) {
    ...
    DispatchingEditorComponent.prototype.resetAllData = function () {
        ...
        this.pinsAdded = [];
        this.AvoidOptions.forEach(function (option) { return option.isChecked = false; });
        this.MinimizeOptions.forEach(function (option) { return option.isChecked = false; });
        this.HazardMaterialOptions.forEach(function (option) { return option.isChecked = false; });
        this.HazardousPermitOptions.forEach(function (option) { return option.isChecked = false; });
        this.clearPoints();
    };
    DispatchingEditorComponent.prototype.setAllDispatchingParameters = function () {
        this.dispatchingParameters.avoid = this.AvoidOptions
            .filter(function (option) { return option.isChecked; }).map(function (option) { return option.value; });
    ...
    DispatchingEditorComponent.ctorParameters = function () { return [
    ...
    return DispatchingEditorComponent;
}());
...
// Copyright (c) Microsoft Corporation. All rights reserved.
// Licensed under the MIT License.
var DispatchingParameters = /** @class */ (function () {
    function DispatchingParameters() {
    }
...
var DispatchingRoutingModule = /** @class */ (function () {
    function DispatchingRoutingModule() {
    }
    ...
    return DispatchingRoutingModule;
}());

var routedComponenets = [
...
var DispatchingShowComponent = /** @class */ (function () {
    function DispatchingShowComponent(dispatchingService, mapService, spinnerService, toasterService) {
        this.dispatchingService = dispatchingService;
    ...
    DispatchingShowComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dispatchingService.getDispatchingResults()
            .subscribe(function (results) {
            _this.directions = results[0].itineraryText;
            _this.directionPoints = results[0].itineraryPoints;
            _this.distances = results[0].itineraryDistance;
            _this.noDirectionsAvailable = _this.directions.length === 0;
            _this.mapService.showAlternativeResults(results[0].alternativeCarRoutePoints);
            _this.mapService.showDispatchingResults(results[0].routePoints, _this.dispatchingService.getPinsAdded());
            _this.spinnerService.stop();
        }, function (error) {
            _this.toasterService.pop('error', 'Error routing', 'An error has occured. Please make sure that the locations you are trying to route to are in the supported regions');
        });
    };
    DispatchingShowComponent.prototype.showItineraryPoint = function (index) {
        this.mapService.showItineraryPosition(this.directionPoints[index]);
    };
    DispatchingShowComponent.ctorParameters = function () { return [
    ...
    return DispatchingShowComponent;
}());
...
var DispatchingModule = /** @class */ (function () {
    function DispatchingModule() {
    }
...
var DispatchingService = /** @class */ (function () {
    function DispatchingService(dataService, router) {
        this.dataService = dataService;
        this.router = router;
    }
    DispatchingService.prototype.callDisaptchingAPI = function (dispatchingParameters) {
        this.dispatchingResults = this.dataService.post('dispatching', dispatchingParameters);
        this.router.navigate(['/dispatching/show']);
    };
    DispatchingService.prototype.getDispatchingResults = function () {
        return this.dispatchingResults;
    };
    DispatchingService.prototype.getPinsAdded = function () {
        return this.pinsAdded;
    };
    DispatchingService.prototype.savePinsAdded = function (pins) {
        this.pinsAdded = pins;
    };
    DispatchingService.ctorParameters = function () { return [
        { type: _core_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }
    ]; };
...
var LocationDialogComponent = /** @class */ (function () {
    function LocationDialogComponent(dialogRef, locationService) {
        this.dialogRef = dialogRef;
        this.locationService = locationService;
    }
    LocationDialogComponent.prototype.ngOnInit = function () {
    };
    LocationDialogComponent.prototype.ngOnDestroy = function () {
        if (this.locationSubscription && !this.locationSubscription.closed) {
            this.locationSubscription.unsubscribe();
        }
    };
    LocationDialogComponent.prototype.onSelected = function (location) {
        this.selectedLocation = location;
    };
    LocationDialogComponent.prototype.onButtonClicked = function () {
...
var GeofenceEditorComponent = /** @class */ (function () {
    function GeofenceEditorComponent(route, router, assetService, geofenceService, mapsService, toasterService) {
        this.route = route;
        this.router = router;
        this.assetService = assetService;
    ...
    GeofenceEditorComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.routeSubscription = this.route.params.subscribe(function (params) {
            var id = params['id'];
            if (id) {
                _this.geofenceSubscription = _this.geofenceService.get(id).subscribe(function (geofence) {
                    if (geofence != null) {
                        _this.geofence = geofence;
                        _this.joinedEmails = _this.geofence.emailsToNotify.join(', ');
                        _this.joinedWebhooks = _this.geofence.webhooksToNotify.join(', ');
                        if (_this.geofence.areaType === _shared_geofence__WEBPACK_IMPORTED_MODULE_2__["AreaType"].Polygon) {
                            _this.mapsService.startPolygonGeofenceDraw(geofence.fencePolygon.slice(0, geofence.fencePolygon.length - 1));
                        }
                        else if (_this.geofence.areaType === _shared_geofence__WEBPACK_IMPORTED_MODULE_2__["AreaType"].Circular) {
                            _this.mapsService.startCircularGeofenceDraw(geofence.fenceCenter, geofence.radiusInMeters);
                        }
                        _this.updateAssetState();
                    }
                });
                _this.isEditable = true;
            }
            else {
                _this.mapsService.startPolygonGeofenceDraw(_this.geofence.fencePolygon);
            }
        });
        this.assetsSubscription = this.assetService.getAssets().subscribe(function (assets) {
            _this.assets.splice(0, _this.assets.length);
    ...
    GeofenceEditorComponent.prototype.submit = function () {
        var _this = this;
        var e_1, _a;
        var checkedAssets = this.assets.filter(function (a) { return a['checked']; });
        this.geofence.assetIds = [];
        try {
            for (var checkedAssets_1 = __values(checkedAssets), checkedAssets_1_1 = checkedAssets_1.next(); !checkedAssets_1_1.done; checkedAssets_1_1 = checkedAssets_1.next()) {
                var checkedAsset = checkedAssets_1_1.value;
            ...
            try {
                if (checkedAssets_1_1 && !checkedAssets_1_1.done && (_a = checkedAssets_1.return)) _a.call(checkedAssets_1);
            }
            finally { if (e_1) throw e_1.error; }
        }
        ...
        if (this.isEditable) {
            this.geofenceService.update(this.geofence)
                .subscribe(function () {
                _this.router.navigate(['/geofences']);
            });
        }
        else {
    ...
    GeofenceEditorComponent.prototype.clearPoints = function () {
        this.mapsService.endCurrentDraw();
    ...
    GeofenceEditorComponent.prototype.updateAssetState = function () {
        var e_2, _a;
    ...
    GeofenceEditorComponent.prototype.onRadiusChanged = function (event) {
        this.mapsService.changeCircularGeofenceRadius(this.geofence.radiusInMeters);
    };
    GeofenceEditorComponent.prototype.onAreaTypeChanged = function (event) {
        this.clearPoints();
    };
    GeofenceEditorComponent.prototype.onAssetCheckChanged = function (event) {
        var e_3, _a;
        try {
            for (var _b = __values(this.assets), _c = _b.next(); !_c.done; _c = _b.next()) {
                var asset = _c.value;
    ...
    GeofenceEditorComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] },
    ...
    return GeofenceEditorComponent;
}());
...
var GeofenceListComponent = /** @class */ (function () {
    function GeofenceListComponent(geofenceService, assetService, mapsService) {
        this.geofenceService = geofenceService;
        this.assetService = assetService;
        this.mapsService = mapsService;
    ...
    GeofenceListComponent.prototype.ngOnInit = function () {
        ...
        this.geofences.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeWhile"])(function () { return _this.isAlive; }))
            .subscribe(function (geofences) {
            _this.mapsService.showGeofences(geofences);
            _this.retrievedGeofences = geofences;
        });
        this.assetService.getLatestPoints().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeWhile"])(function () { return _this.isAlive; }))
            .subscribe(function (points) {
            _this.mapsService.showAssetsPositions(points, true);
        });
    };
    GeofenceListComponent.prototype.ngOnDestroy = function () {
        this.isAlive = false;
    };
    GeofenceListComponent.prototype.showGeofence = function (geofence) {
    ...
    GeofenceListComponent.prototype.deleteGeofence = function (geofence) {
        this.geofenceService.remove(geofence);
    };
    GeofenceListComponent.ctorParameters = function () { return [
...
var GeofenceService = /** @class */ (function () {
    ...
    GeofenceService.ctorParameters = function () { return [
...
var GeofencesRoutingModule = /** @class */ (function () {
    function GeofencesRoutingModule() {
    }
    ...
    return GeofencesRoutingModule;
}());

var geofencesRoutedComponents = [
...
var GeofencesModule = /** @class */ (function () {
...
var LocationEditorComponent = /** @class */ (function () {
    function LocationEditorComponent(locationService, mapService, route, router, toasterService) {
        this.locationService = locationService;
        this.mapService = mapService;
        this.route = route;
        this.router = router;
    ...
    LocationEditorComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.isAlive = true;
        this.location = new _shared_location__WEBPACK_IMPORTED_MODULE_2__["Location"]();
        this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeWhile"])(function () { return _this.isAlive; }))
            .subscribe(function (params) {
            var id = params['id'];
            if (id) {
                _this.isEditable = true;
                _this.locationService.getLocation(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeWhile"])(function () { return _this.isAlive; }))
                    .subscribe(function (location) {
                    if (location) {
                        _this.location = location;
                        _this.setlocationString();
                        _this.mapService.showLocationsPositions([_this.location]);
                    }
                });
            }
            _this.mapService.startLocationPinDraw(_this.location);
        });
        this.mapService.getLocationPinResult().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeWhile"])(function () { return _this.isAlive; }))
            .subscribe(function (location) {
            if (_this.location.latitude !== location.latitude || _this.location.longitude !== location.longitude) {
                _this.didLocationChange = true;
                _this.location.latitude = location.latitude;
                _this.location.longitude = location.longitude;
                _this.location.address = location.address;
                if (!_this.location.name) {
                    _this.location.name = location.name;
                }
                _this.setlocationString();
            }
        });
    };
    LocationEditorComponent.prototype.ngOnDestroy = function () {
        this.mapService.endCurrentDraw();
        this.isAlive = false;
    };
    LocationEditorComponent.prototype.changeAddress = function () {
        var _this = this;
        var address = this.location.address;
        this.mapService.geocodeQuery(address);
        this.mapService.getGeocodeResult().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1)).subscribe(function (point) {
            _this.location.latitude = point.latitude;
            _this.location.longitude = point.longitude;
            _this.setlocationString();
            _this.mapService.showLocationsPositions([_this.location]);
        });
    };
    LocationEditorComponent.prototype.submit = function () {
        var _this = this;
        ...
        if (this.isEditable) {
            this.locationService.updateLocation(this.location)
                .subscribe(function () { return _this.router.navigate(['/locations']); });
        }
        else {
    ...
    LocationEditorComponent.prototype.setlocationString = function () {
        this.locationString = '(' + this.location.latitude + ' , ' + this.location.longitude + ' )';
    };
    LocationEditorComponent.ctorParameters = function () { return [
...
var LocationListComponent = /** @class */ (function () {
    function LocationListComponent(locationService, assetService, mapsService) {
        this.locationService = locationService;
        this.assetService = assetService;
        this.mapsService = mapsService;
    ...
    LocationListComponent.prototype.showFirstPageLocations = function () {
        var _this = this;
        this.locationService.getLocations().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeWhile"])(function () { return _this.isAlive; }))
            .subscribe(function (locations) {
            _this.locations = locations;
            _this.showLocationsRange(_this.locations.slice(0, _this.singlePageSize - 1));
        });
    };
    LocationListComponent.prototype.ngOnDestroy = function () {
        this.isAlive = false;
    };
    LocationListComponent.prototype.showLocationsRange = function (locationRange) {
        this.mapsService.showLocationsPositions(locationRange);
    };
    LocationListComponent.prototype.showLocation = function (location) {
    ...
    LocationListComponent.prototype.selectPage = function (index) {
        this.index = index;
        var pagedLocations = this.locations.slice((index - 1) * this.singlePageSize, (index * this.singlePageSize) + 1);
        this.showLocationsRange(pagedLocations);
    };
    LocationListComponent.prototype.getLocationInformation = function (location) {
        var _this = this;
        this.assetsCount = null;
        this.locationService.getLocationAssetsCount(location).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeWhile"])(function () { return _this.isAlive; }))
            .subscribe(function (assetsCount) {
            _this.assetsCount = Object.keys(assetsCount).map(function (key) {
                return {
                    key: key, value: assetsCount[key]
                };
            });
            _this.showTable = (_this.assetsCount.length >= 1);
        });
    };
...
var LocationService = /** @class */ (function () {
    function LocationService(dataSevrice) {
    ...
    LocationService.prototype.getLocationAssetsCount = function (location) {
...
var BingMapsService = /** @class */ (function () {
    function BingMapsService(tripService) {
    ...
    /* GENERIC FUNCTIONS */
    BingMapsService.prototype.init = function (element, options) {
        var _this = this;
        this.load().then(function () {
            _this.map = new Microsoft.Maps.Map(element, options);
            if (!_this.searchManager) {
                Microsoft.Maps.loadModule('Microsoft.Maps.Search', function () {
                    _this.searchManager = new Microsoft.Maps.Search.SearchManager(_this.map);
                });
            }
            _this.geofencesLayer = new Microsoft.Maps.Layer('geofencesLayer');
            _this.assetsLayer = new Microsoft.Maps.Layer('assetsLayer');
            _this.devicesLayer = new Microsoft.Maps.Layer('devicesLayer');
            _this.tripsLayer = new Microsoft.Maps.Layer('tripsLayer');
            _this.locationsLayer = new Microsoft.Maps.Layer('locationsLayer');
            _this.pointsLayer = new Microsoft.Maps.Layer('pointsLayer');
            _this.map.layers.insert(_this.geofencesLayer);
            _this.map.layers.insert(_this.assetsLayer);
            _this.map.layers.insert(_this.devicesLayer);
            _this.map.layers.insert(_this.tripsLayer);
            _this.map.layers.insert(_this.locationsLayer);
            _this.map.layers.insert(_this.pointsLayer);
        });
    };
    BingMapsService.prototype.endCurrentDraw = function () {
        if (this.drawHandlerId) {
            Microsoft.Maps.Events.removeHandler(this.drawHandlerId);
            this.drawHandlerId = null;
        }
    };
    BingMapsService.prototype.centerMap = function (point, zoom) {
    ...
    BingMapsService.prototype.load = function () {
        if (this.loadPromise) {
        ...
        script.async = true;
        script.defer = true;
        var mapsCallback = 'bingMapsCallback';
    ...
    BingMapsService.prototype.centerMapOnMedian = function (points) {
        if (points.length) {
    ...
    BingMapsService.prototype.centerMapOnMean = function (points) {
        if (points.length) {
            var centerLat_1 = 0;
            var centerLong_1 = 0;
            points.forEach(function (p) {
                centerLat_1 += p.latitude;
                centerLong_1 += p.longitude;
            });
            centerLat_1 /= points.length;
            centerLong_1 /= points.length;
            this.map.setView({
                center: new Microsoft.Maps.Location(centerLat_1, centerLong_1)
            });
        }
    };
    BingMapsService.prototype.timeConverter = function (timestamp) {
        var a = new Date(timestamp);
        return a.toLocaleString('en-US', { month: 'short', day: 'numeric', hour: 'numeric', minute: 'numeric', second: 'numeric' });
    };
    BingMapsService.prototype.resetMap = function () {
    ...
    /* GEOFENCES FUNCTIONS */
    BingMapsService.prototype.showGeofences = function (geofences) {
        var _this = this;
        this.load().then(function () {
            var e_1, _a;
            _this.resetMap();
            _this.assetsLayer.setVisible(true);
            _this.geofencesLayer.setVisible(true);
            _this.geofencesLayer.clear();
            var lastGeofencePolygon;
            try {
                for (var geofences_1 = __values(geofences), geofences_1_1 = geofences_1.next(); !geofences_1_1.done; geofences_1_1 = geofences_1.next()) {
                    var geofence = geofences_1_1.value;
                    lastGeofencePolygon = _this.showGeofencePolygon(geofence, _this.geofenceGreenBlue, _this.genericColors[0]);
                }
            }
            catch (e_1_1) { e_1 = { error: e_1_1 }; }
            finally {
                try {
                    if (geofences_1_1 && !geofences_1_1.done && (_a = geofences_1.return)) _a.call(geofences_1);
                }
                finally { if (e_1) throw e_1.error; }
            }
            _this.centerMapOnMean(lastGeofencePolygon);
        });
    };
    BingMapsService.prototype.showGeofence = function (geofence) {
        var _this = this;
        this.load().then(function () {
            _this.resetMap();
            _this.assetsLayer.setVisible(true);
            _this.geofencesLayer.setVisible(true);
            _this.geofencesLayer.clear();
            var polygonLocations = _this.showGeofencePolygon(geofence, _this.geofenceGreenBlue, _this.genericColors[0]);
            _this.centerMapOnMean(polygonLocations);
        });
    };
    BingMapsService.prototype.drawCircularGeofence = function (subject, initialCenter, initialRadius, radius) {
        var _this = this;
        this.load().then(function () {
            var tempGeofence = new _shared_geofence__WEBPACK_IMPORTED_MODULE_4__["Geofence"]();
            ...
            if (initialCenter && initialCenter.latitude && initialCenter.longitude && initialRadius) {
                _this.showGeofencePolygon(tempGeofence, _this.geofenceGreenBlue, _this.genericColors[0]);
            }
            // If new center set, update temp geofence and redraw
            _this.drawHandlerId = Microsoft.Maps.Events.addHandler(_this.map, 'click', function (e) {
                var event = e;
                tempGeofence.fenceCenter.latitude = event.location.latitude;
                tempGeofence.fenceCenter.longitude = event.location.longitude;
                _this.geofencesLayer.clear();
                _this.showGeofencePolygon(tempGeofence, _this.geofencePink, _this.genericColors[4], '/assets/images/circular-geofence-center-pink.svg');
            ...
            var currentDrawHandlerId = _this.drawHandlerId;
            radius
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["takeWhile"])(function () { return currentDrawHandlerId === _this.drawHandlerId; }))
    ...
    BingMapsService.prototype.drawPolygonGeofence = function (subject, initialPoints) {
        var _this = this;
        this.load().then(function () {
            var tempGeofence = new _shared_geofence__WEBPACK_IMPORTED_MODULE_4__["Geofence"]();
            ...
            _this.drawHandlerId = Microsoft.Maps.Events.addHandler(_this.map, 'click', function (e) {
                ...
                if (tempGeofence.fencePolygon.length > 1) {
                    _this.showGeofencePolygon(tempGeofence, _this.geofencePink, _this.genericColors[4]);
                }
                else {
                    var pushpin = new Microsoft.Maps.Pushpin(event.location, {
                        color: _this.genericColors[4]
                    });
                    _this.geofencesLayer.add(pushpin);
                }
                subject.next(tempGeofence.fencePolygon);
            });
        });
    };
    BingMapsService.prototype.showGeofencePolygon = function (geofence, fillColor, strokeColor, circularIcon) {
        var e_2, _a;
        if (circularIcon === void 0) { circularIcon = '/assets/images/circular-geofence-center-green.svg'; }
        var locations = new Array();
        if (geofence.areaType === _shared_geofence__WEBPACK_IMPORTED_MODULE_4__["AreaType"].Polygon) {
            try {
                for (var _b = __values(geofence.fencePolygon), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var p = _c.value;
                    var location_1 = new Microsoft.Maps.Location(p.latitude, p.longitude);
            ...
            var pushpin = new Microsoft.Maps.Pushpin(new Microsoft.Maps.Location(geofence.fenceCenter.latitude, geofence.fenceCenter.longitude), {
                color: strokeColor,
                icon: circularIcon,
    ...
    BingMapsService.prototype.getCirclePolygon = function (center, radiusInMeters) {
        ...
        var lat = center.latitude * radPerDeg;
        var lon = center.longitude * radPerDeg;
        var angDist = parseFloat(radiusInMeters) / earthRadiusInMeters;
        for (var i = 0; i <= 360; i++) {
            var pLatitude = void 0, pLongitude = void 0;
            var brng = i * radPerDeg;
    ...
    /* LOCATION FUNCTIONS */
    BingMapsService.prototype.drawLocationPin = function (subject, location) {
        var _this = this;
        this.load().then(function () {
            var tempLocation = new _shared_location__WEBPACK_IMPORTED_MODULE_5__["Location"]();
            tempLocation.name = 'New Location';
            if (location && location.name) {
                tempLocation.name = location.name;
            }
            _this.resetMap();
            _this.locationsLayer.setVisible(true);
            _this.locationsLayer.clear();
            _this.drawHandlerId = Microsoft.Maps.Events.addHandler(_this.map, 'click', function (e) {
                var event = e;
                tempLocation.latitude = event.location.latitude;
                tempLocation.longitude = event.location.longitude;
                _this.locationsLayer.clear();
                _this.showLocation(tempLocation);
                _this.searchManager.reverseGeocode({
                    location: event.location,
                    callback: function (placeResult) {
    ...
    BingMapsService.prototype.drawDispatchingRoute = function (subject, initialLocations) {
        var _this = this;
        this.load().then(function () {
            var tempRoutePoints = initialLocations || new Array();
            _this.resetMap();
            _this.assetsLayer.setVisible(true);
            _this.locationsLayer.setVisible(true);
            _this.locationsLayer.clear();
            if (initialLocations) {
                _this.showDispatchingRoutePins(tempRoutePoints);
            }
            _this.drawHandlerId = Microsoft.Maps.Events.addHandler(_this.map, 'click', function (e) {
                var event = e;
                var newLocation = new _shared_location__WEBPACK_IMPORTED_MODULE_5__["Location"]();
                ...
                _this.showLocation(newLocation);
                tempRoutePoints.push(newLocation);
                subject.next(tempRoutePoints);
            });
        });
    };
    BingMapsService.prototype.showDispatchingRoute = function (points, clearMap, colorIndex) {
        var _this = this;
        this.load().then(function () {
            var e_3, _a;
            if (clearMap) {
            ...
            if (points && points.length >= 1) {
                ...
                var polyline = new Microsoft.Maps.Polyline(locations, {
                    strokeColor: _this.tripColors[colorIndex % _this.tripColors.length],
                    strokeThickness: 2
                });
                _this.locationsLayer.add(polyline);
                _this.centerMap(points[0]);
            }
        });
    };
    BingMapsService.prototype.showDispatchingRoutePins = function (locations) {
        var _this = this;
        this.load().then(function () {
    ...
    BingMapsService.prototype.showLocations = function (locations) {
        var _this = this;
        this.load().then(function () {
            _this.resetMap();
            _this.assetsLayer.setVisible(true);
            ...
            _this.centerMapOnMedian(locations);
        });
    };
    BingMapsService.prototype.geocodeAddress = function (address) {
        var _this = this;
        var subject = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
        this.load().then(function () {
            _this.searchManager.geocode({
                where: address,
                count: 1,
                callback: function (geocodeResult) {
                    var res = geocodeResult.results[0];
                    var p = new _shared_point__WEBPACK_IMPORTED_MODULE_3__["Point"]();
    ...
    BingMapsService.prototype.showLocation = function (location, icon) {
        if (icon === void 0) { icon = '/assets/images/location-pin.png'; }
        var mapLocation = new Microsoft.Maps.Location(location.latitude, location.longitude);
        var pushpin = new Microsoft.Maps.Pushpin(mapLocation, {
            title: location.name,
    ...
    BingMapsService.prototype.getNormalizedLocationName = function (location) {
    ...
    /* POINT FUNCTIONS */
    BingMapsService.prototype.showPoints = function (points) {
        var _this = this;
        this.load().then(function () {
            _this.resetMap();
            _this.pointsLayer.setVisible(true);
            _this.pointsLayer.clear();
            points.forEach(function (p) { return _this.showPoint(p, _this.genericColors[4]); });
            _this.centerMapOnMedian(points);
        });
    };
    BingMapsService.prototype.showPoint = function (point, color) {
    ...
    /* END POINT FUNCTIONS */
    /* ASSET FUNCTIONS */
    BingMapsService.prototype.showAssets = function (positions, centerMap, clearMap) {
        var _this = this;
        this.load().then(function () {
            var e_4, _a;
            if (clearMap) {
            ...
            try {
                for (var positions_1 = __values(positions), positions_1_1 = positions_1.next(); !positions_1_1.done; positions_1_1 = positions_1.next()) {
                    ...
                    if (p != null) {
                        points.push(p);
                        var location_2 = new Microsoft.Maps.Location(p.latitude, p.longitude);
                        var pushpin = new Microsoft.Maps.Pushpin(location_2, {
                            title: position[0].name,
                            subTitle: _this.timeConverter(p.time),
    ...
    /* END ASSET FUNCTIONS */
    /* DEVICE FUNCTIONS */
    BingMapsService.prototype.showDevices = function (positions, centerMap, clearMap) {
        var _this = this;
        this.load().then(function () {
            if (clearMap) {
                _this.resetMap();
                _this.devicesLayer.setVisible(true);
            }
            _this.devicesLayer.clear();
            var points = [];
            positions.forEach(function (value, key) {
                if (value != null) {
                    points.push(value);
                    var location_3 = new Microsoft.Maps.Location(value.latitude, value.longitude);
                    var pushpin = new Microsoft.Maps.Pushpin(location_3, {
                        title: key,
                        subTitle: _this.timeConverter(value.time),
                        icon: '/assets/images/phone.png'
                    });
                    _this.devicesLayer.add(pushpin);
                }
            });
            if (centerMap) {
                _this.centerMapOnMedian(points);
    ...
    /* TRIP FUNCTIONS*/
    BingMapsService.prototype.showTrips = function (trips) {
        var _this = this;
        this.load().then(function () {
            var e_5, _a;
            _this.resetMap();
            _this.tripsLayer.setVisible(true);
            _this.tripsLayer.clear();
            var colorIndex = 0;
            try {
                for (var trips_1 = __values(trips), trips_1_1 = trips_1.next(); !trips_1_1.done; trips_1_1 = trips_1.next()) {
                    var trip = trips_1_1.value;
                    _this.showSimplifiedTrip(trip, _this.tripColors[colorIndex++ % _this.tripColors.length]);
                }
            }
            catch (e_5_1) { e_5 = { error: e_5_1 }; }
            finally {
                try {
                    if (trips_1_1 && !trips_1_1.done && (_a = trips_1.return)) _a.call(trips_1);
                }
                finally { if (e_5) throw e_5.error; }
            }
        });
    };
    BingMapsService.prototype.showTrip = function (trip, color) {
        var _this = this;
        this.load().then(function () {
            _this.resetMap();
            _this.tripsLayer.setVisible(true);
            _this.tripsLayer.clear();
            _this.showDetailedTrip(trip);
            _this.drawHandlerId = Microsoft.Maps.Events.addHandler(_this.map, 'click', function (e) {
                var event = e;
                _this.tripService.getPoints(trip.id, event.location.latitude, event.location.longitude).subscribe(function (points) {
                    var e_6, _a;
                    try {
                        for (var points_2 = __values(points), points_2_1 = points_2.next(); !points_2_1.done; points_2_1 = points_2.next()) {
                            ...
                            var pinColor = void 0;
                            if (point.speed >= _this.greenSpeed) {
                                pinColor = 'green';
                            }
                            else if (point.speed < _this.greenSpeed &&
                                point.speed >= _this.yellowSpeed) {
                                pinColor = 'yellow';
                            }
                            else {
                                pinColor = 'red';
                            }
                            var location_4 = new Microsoft.Maps.Location(point.latitude, point.longitude);
                            var pushPin = new Microsoft.Maps.Pushpin(location_4, {
                                color: pinColor,
                                title: _this.timeConverter(point.time),
                                subTitle: "speed: " + Math.round(point.speed * 3.6) + " km/hr, accuracy: " + point.accuracy
                            });
                            _this.tripsLayer.add(pushPin);
                        }
                    }
    ...
    BingMapsService.prototype.showDetailedTrip = function (trip) {
        var e_7, _a;
        var colorIndex = 0;
        var previousTripLeg;
        try {
            for (var _b = __values(trip.tripLegs), _c = _b.next(); !_c.done; _c = _b.next()) {
                var leg = _c.value;
                var tripLegLocations = [];
                ...
                for (var i = 0; i < leg.route.length; i++) {
                ...
                var line = new Microsoft.Maps.Polyline(tripLegLocations, {
                    strokeThickness: 5,
                ...
                if (previousTripLeg && previousTripLeg.endLocation.id !== leg.startLocation.id) {
                    var startPoint = new Microsoft.Maps.Location(leg.startLocation.latitude, leg.startLocation.longitude);
                    var previousLocation = new Microsoft.Maps.Location(previousTripLeg.endLocation.latitude, previousTripLeg.endLocation.longitude);
                    var dottedLine = new Microsoft.Maps.Polyline([previousLocation, startPoint], {
                        strokeThickness: 5,
                        strokeDashArray: [2, 2],
    ...
    BingMapsService.prototype.showSimplifiedTrip = function (trip, tripColor) {
        var e_8, _a;
    ...
    BingMapsService.prototype.showTripLocation = function (location, icon) {
        if (icon === void 0) { icon = '/assets/images/location-pin.png'; }
        var mapLocation = new Microsoft.Maps.Location(location.latitude, location.longitude);
        var pushpin = new Microsoft.Maps.Pushpin(mapLocation, {
            title: location.name,
    ...
    BingMapsService.ctorParameters = function () { return [
...
var MapsService = /** @class */ (function () {
    ...
    MapsService.prototype.geocodeQuery = function (address) {
        this.locationSearchQuery.next(address);
    };
    MapsService.prototype.geocodeResult = function (point) {
        this.locationSearchResult.next(point);
    };
    MapsService.prototype.showPoints = function (points) {
        this.points.next(points);
    };
    MapsService.prototype.showGeofence = function (geofence) {
        this.geofence.next(geofence);
    };
    MapsService.prototype.showGeofences = function (geofences) {
        this.geofences.next(geofences);
    };
    MapsService.prototype.startPolygonGeofenceDraw = function (initialPoints) {
        if (initialPoints === void 0) { initialPoints = null; }
        this.geofencePolygonDraw.next(initialPoints);
    };
    MapsService.prototype.startCircularGeofenceDraw = function (initialCenter, radius) {
        if (initialCenter === void 0) { initialCenter = null; }
        this.geofenceCircularDraw.next([initialCenter, radius]);
    };
    MapsService.prototype.changeCircularGeofenceRadius = function (radius) {
        this.geofenceCircularRadiusChange.next(radius);
    };
    MapsService.prototype.showAssetsPositions = function (positions, inBackground) {
        if (inBackground === void 0) { inBackground = false; }
        this.assetsPositions.next([positions, inBackground]);
    };
    MapsService.prototype.showAsset = function (position) {
        this.assetPosition.next(position);
    };
    MapsService.prototype.showDevicesPositions = function (positions, inBackground) {
        if (inBackground === void 0) { inBackground = false; }
        this.devicesPositions.next([positions, inBackground]);
    };
    MapsService.prototype.showDevice = function (position) {
        this.devicePosition.next(position);
    };
    MapsService.prototype.showLocationsPositions = function (positions) {
        this.locationsPositions.next(positions);
    };
    MapsService.prototype.zoomToLocation = function (position) {
        this.locationPosition.next(position);
    };
    MapsService.prototype.startLocationPinDraw = function (location) {
        this.locationPinDraw.next(location);
    };
    MapsService.prototype.endCurrentDraw = function () {
        this.currentDrawEnd.next(null);
    };
    MapsService.prototype.showTrips = function (trips) {
        this.trips.next(trips);
    };
    MapsService.prototype.showTrip = function (trip) {
        this.trip.next(trip);
    };
    MapsService.prototype.showDispatchingResults = function (points, pins) {
        this.dispatchingPoints.next(points);
        this.dispatchingPins.next(pins);
    };
    MapsService.prototype.showAlternativeResults = function (altPoints) {
        this.dispatchingAlternativePoints.next(altPoints);
    };
    MapsService.prototype.setRouteColor = function (color) {
        if (color === void 0) { color = 0; }
        this.routeColor = color;
    };
    MapsService.prototype.startDispatchingPinsDraw = function (initialPoints) {
        if (initialPoints === void 0) { initialPoints = null; }
        this.dispatchingPinsDraw.next(initialPoints);
        this.dispatchingPinsDrawResult.next([]);
    };
    MapsService.prototype.showItineraryPosition = function (point) {
        this.itineraryPoint.next(point);
    };
    MapsService.prototype.getPoints = function () {
        return this.points.asObservable();
    };
    MapsService.prototype.getAssetsPositions = function () {
        return this.assetsPositions.asObservable();
    };
    MapsService.prototype.getAssetPosition = function () {
        return this.assetPosition.asObservable();
    };
    MapsService.prototype.getDevicesPositions = function () {
        return this.devicesPositions.asObservable();
    };
    MapsService.prototype.getDevicePosition = function () {
        return this.devicePosition.asObservable();
    };
    MapsService.prototype.getLocationsPositions = function () {
        return this.locationsPositions.asObservable();
    };
    MapsService.prototype.getLocationPosition = function () {
        return this.locationPosition.asObservable();
    };
    MapsService.prototype.getLocationPinDraw = function () {
        return this.locationPinDraw.asObservable();
    };
    MapsService.prototype.getLocationPinResult = function () {
        return this.locationPinResult.asObservable();
    };
    MapsService.prototype.getLocationPinResultSubject = function () {
        return this.locationPinResult;
    };
    MapsService.prototype.getDispatchingPinsDraw = function () {
        return this.dispatchingPinsDraw.asObservable();
    };
    MapsService.prototype.getDispatchingPinsResult = function () {
        return this.dispatchingPinsDrawResult.asObservable();
    };
    MapsService.prototype.getDispatchingPinsResultSubject = function () {
        return this.dispatchingPinsDrawResult;
    };
    MapsService.prototype.getDispatchingPoints = function () {
        return this.dispatchingPoints.asObservable();
    };
    MapsService.prototype.getRouteColor = function () {
        return this.routeColor;
    };
    MapsService.prototype.getDispatchingPins = function () {
        return this.dispatchingPins.asObservable();
    };
    MapsService.prototype.getDispatchingAltPoints = function () {
        return this.dispatchingAlternativePoints.asObservable();
    };
    MapsService.prototype.getItineraryPosition = function () {
        return this.itineraryPoint.asObservable();
    };
    MapsService.prototype.getTrip = function () {
        return this.trip.asObservable();
    };
    MapsService.prototype.getTrips = function () {
        return this.trips.asObservable();
    };
    MapsService.prototype.getGeofence = function () {
        return this.geofence.asObservable();
    };
    MapsService.prototype.getGeofences = function () {
        return this.geofences.asObservable();
    };
    MapsService.prototype.getGeofencePolygonDraw = function () {
        return this.geofencePolygonDraw.asObservable();
    };
    MapsService.prototype.getGeofenceCircularDraw = function () {
        return this.geofenceCircularDraw.asObservable();
    };
    MapsService.prototype.getCurrentDrawEnd = function () {
        return this.currentDrawEnd.asObservable();
    };
    MapsService.prototype.getGeodencePolygonDrawResult = function () {
        return this.geofencePolygonDrawResult.asObservable();
    };
    MapsService.prototype.getGeodenceCircularDrawResult = function () {
        return this.geofenceCircularDrawResult.asObservable();
    };
    MapsService.prototype.getCircularGeofenceRadiusChange = function () {
        return this.geofenceCircularRadiusChange.asObservable();
    };
    MapsService.prototype.getGeofencePolygonDrawResultSubject = function () {
        return this.geofencePolygonDrawResult;
    };
    MapsService.prototype.getGeofenceCircularDrawResultSubject = function () {
        return this.geofenceCircularDrawResult;
    };
    MapsService.prototype.resetDispatchingDraw = function (initialPoints) {
        if (initialPoints === void 0) { initialPoints = null; }
        this.endCurrentDraw();
        this.startDispatchingPinsDraw(initialPoints);
    };
    MapsService.prototype.getGeocodeQuery = function () {
        return this.locationSearchQuery.asObservable();
    };
    MapsService.prototype.getGeocodeResult = function () {
...
var MapsComponent = /** @class */ (function () {
    function MapsComponent(bingMapsService, settingsService, assetsService, mapsService) {
    ...
    MapsComponent.prototype.ngOnInit = function () {
        ...
        this.settingsService
            ...
            _this.bingMapsService.init(_this.mapElement.nativeElement, {
            ...
            _this.mapsService.getGeocodeQuery()
                .subscribe(function (address) { return _this.bingMapsService.geocodeAddress(address)
                .subscribe(function (point) { return _this.mapsService.geocodeResult(point); }); });
            _this.mapsService
                .getPoints()
                .subscribe(function (points) { return _this.bingMapsService.showPoints(points); });
            _this.mapsService
                .getTrips()
                .subscribe(function (trips) { return _this.bingMapsService.showTrips(trips); });
            _this.mapsService
                .getTrip()
                .subscribe(function (trip) { return _this.bingMapsService.showTrip(trip); });
            _this.mapsService
                .getGeofence()
                .subscribe(function (geofence) { return _this.bingMapsService.showGeofence(geofence); });
            _this.mapsService
                .getDispatchingAltPoints()
                .subscribe(function (points) {
                return _this.bingMapsService.showDispatchingRoute(points, true, _this.mapsService.getRouteColor() + 1);
            });
            _this.mapsService
                .getDispatchingPoints()
                .subscribe(function (points) {
                return _this.bingMapsService.showDispatchingRoute(points, false, _this.mapsService.getRouteColor());
            });
            _this.mapsService
                .getDispatchingPins()
                .subscribe(function (pins) {
                return _this.bingMapsService.showDispatchingRoutePins(pins);
            });
            _this.mapsService
                .getAssetPosition()
                .subscribe(function (position) {
                return _this.bingMapsService.centerMap(position[1], 15);
            });
            _this.mapsService
                .getDevicePosition()
                .subscribe(function (position) {
            ...
            _this.mapsService
                .getLocationPosition()
                .subscribe(function (position) {
                return _this.bingMapsService.centerMap(position, 15);
            });
            _this.mapsService
            ...
            _this.mapsService.getGeofenceCircularDraw().subscribe(function (draw) {
                _this.bingMapsService.drawCircularGeofence(_this.mapsService.getGeofenceCircularDrawResultSubject(), draw[0], draw[1], _this.mapsService.getCircularGeofenceRadiusChange());
            });
            _this.mapsService.getGeofencePolygonDraw().subscribe(function (draw) {
                _this.bingMapsService.drawPolygonGeofence(_this.mapsService.getGeofencePolygonDrawResultSubject(), draw);
            });
            _this.mapsService
                .getCurrentDrawEnd()
                .subscribe(function (drawEnd) { return _this.bingMapsService.endCurrentDraw(); });
            _this.mapsService.getLocationPinDraw().subscribe(function (location) {
                _this.bingMapsService.drawLocationPin(_this.mapsService.getLocationPinResultSubject(), location);
            });
            _this.mapsService.getDispatchingPinsDraw().subscribe(function (draw) {
                _this.bingMapsService.drawDispatchingRoute(_this.mapsService.getDispatchingPinsResultSubject(), draw);
            });
            var assets = new Array();
            _this.assetsService.getAssets().subscribe(function (a) { return assets = a; });
            // Use lastPositionCall to track the last position call made so that not to recenter the map
            // if this is just an update call.
            var lastPositionCall;
            // Do the mapping in this layer to avoid having to redo in multiple components
            _this.mapsService.getAssetsPositions().subscribe(function (data) {
                var e_1, _a;
                var positions = data[0];
                var mappedAssets = new Array();
                var _loop_1 = function (k) {
                    var value = positions[k];
                    var asset = assets.find(function (val) { return val.name === k; });
                    if (asset) {
                        mappedAssets.push([asset, value]);
                    }
                };
                try {
                    for (var _b = __values(Object.keys(positions)), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var k = _c.value;
                        _loop_1(k);
                    }
                }
                ...
                _this.bingMapsService.showAssets(mappedAssets, !data[1] && lastPositionCall !== 'assets', !data[1]);
                lastPositionCall = 'assets';
            });
            _this.mapsService.getDevicesPositions().subscribe(function (data) {
                _this.bingMapsService.showDevices(data[0], !data[1] && lastPositionCall !== 'devices', !data[1]);
                lastPositionCall = 'devices';
            });
            _this.mapsService.getLocationsPositions().subscribe(function (positions) {
                _this.bingMapsService.showLocations(positions);
            });
            _this.mapsService.getGeofences().subscribe(function (geofences) {
                _this.bingMapsService.showGeofences(geofences);
...
var ReportChartComponent = /** @class */ (function () {
    function ReportChartComponent(reportService) {
    ...
    ReportChartComponent.prototype.ngOnInit = function () {
        ...
        this.metricSubscription = this.reportService.getSelectedMetric()
            .subscribe(function (next) { return _this.onMetricSelected(next); });
    };
    ReportChartComponent.prototype.ngOnDestroy = function () {
        this.metricSubscription.unsubscribe();
    };
    ReportChartComponent.prototype.onMetricSelected = function (metric) {
    ...
    // events
    ReportChartComponent.prototype.chartClicked = function (e) {
        console.log(e);
    };
    ReportChartComponent.prototype.chartHovered = function (e) {
        console.log(e);
    };
    ReportChartComponent.ctorParameters = function () { return [
...
var ReportListComponent = /** @class */ (function () {
    ...
    ReportListComponent.prototype.ngOnInit = function () {
        ...
        this.metricsSubscription = this.metrics.subscribe(function (values) {
            if (values.length > 0) {
                _this.selectMetric(values[0]);
            }
        });
    };
    ...
    ReportListComponent.prototype.selectMetric = function (metric) {
...
var ReportService = /** @class */ (function () {
    ...
    ReportService.prototype.getAllMetrics = function () {
        return this.dataService.get('reports');
    };
    ReportService.prototype.getSelectedMetric = function () {
        return this.selectedMetric.asObservable();
    };
    ReportService.prototype.setSelectedMetric = function (metric) {
...
// Copyright (c) Microsoft Corporation. All rights reserved.
// Licensed under the MIT License.
var AssetProperties = /** @class */ (function () {
...
var FilterListPipe = /** @class */ (function () {
    ...
    FilterListPipe.prototype.transform = function (items, args) {
        var query = args;
        if (!query) {
            return items;
        }
...
var Location = /** @class */ (function (_super) {
    ...
    return Location;
}(_point__WEBPACK_IMPORTED_MODULE_0__["Point"]));
...
var RoleLimiterDirective = /** @class */ (function () {
    function RoleLimiterDirective(el, authService) {
        this.el = el;
        this.authService = authService;
    }
    RoleLimiterDirective.prototype.ngOnInit = function () {
        var _this = this;
        this.authService.getLoggedInUser().subscribe(function (user) {
            if (user == null) {
                return;
            }
            if (_this.appRoleLimiter > _role__WEBPACK_IMPORTED_MODULE_2__["Roles"][user.role.name]) {
                _this.el.nativeElement.style.display = 'none';
            }
        });
    };
    RoleLimiterDirective.ctorParameters = function () { return [
...
var Role = /** @class */ (function () {
    ...
    Role.ctorParameters = function () { return [
        null
    ]; };
    return Role;
}());
...
var TimeFilterComponent = /** @class */ (function () {
    ...
    TimeFilterComponent.prototype.select = function (range) {
    ...
    TimeFilterComponent.prototype.onDateRangeChanged = function (event) {
    ...
    TimeFilterComponent.prototype.convertDate = function (date) {
        return {
            day: date.getDate(),
...
var TripListComponent = /** @class */ (function () {
    ...
    TripListComponent.prototype.selectTrip = function (trip) {
...
var AuthService = /** @class */ (function () {
    function AuthService(dataService, envSettingsService) {
        this.dataService = dataService;
        this.envSettingsService = envSettingsService;
    ...
    AuthService.prototype.getLoggedInUser = function () {
        ...
        if (this.loggedInUser == null) {
            ...
            this.dataService.getSingle('users', 'me')
                .subscribe(function (a) { return _this.loggedInUser.next(a); }, function (e) { return _this.loggedInUser.error(e); });
        }
        return this.loggedInUser.asObservable();
    };
    AuthService.prototype.loginOrGetUser = function () {
        var _this = this;
        var observable = this.getLoggedInUser();
        observable.subscribe(function (d) { }, function (e) {
            if (e.status === 401) {
                _this.login();
            }
        });
...
var InstrumentationApprovalComponent = /** @class */ (function () {
    function InstrumentationApprovalComponent() {
    }
    ...
    return InstrumentationApprovalComponent;
}());
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(authService, reportService, settingsService, toasterService, dialog) {
        this.authService = authService;
        this.reportService = reportService;
        this.settingsService = settingsService;
        this.toasterService = toasterService;
    ...
    LoginComponent.prototype.ngOnInit = function () {
        ...
        this.userSubscription = this.authService.loginOrGetUser()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["skipWhile"])(function (v) { return v === null; }))
            .subscribe(function (value) {
            _this.loggedInUser = value;
            _this.link = _this.authService.getLogoutUrl();
            ...
            if (value.role.name === _shared_role__WEBPACK_IMPORTED_MODULE_3__["Roles"][_shared_role__WEBPACK_IMPORTED_MODULE_3__["Roles"].Owner]) {
                _this.settingsService.getVersionInfo()
                    ...
                    if (result.updateRequired) {
                        var toast = {
                            ...
                            clickHandler: function (t, isClosed) {
                                if (!isClosed) {
                ...
                _this.settingsService.getInstrumentationApproval().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["take"])(1)).subscribe(function (val) {
                    if (val == null) {
                        _this.dialog.open(_instrumentation_approval_instrumentation_approval_component__WEBPACK_IMPORTED_MODULE_7__["InstrumentationApprovalComponent"], {
                            width: '70%',
...
var UserEditorComponent = /** @class */ (function () {
    function UserEditorComponent(route, router, userService, toasterService) {
        this.route = route;
        this.router = router;
    ...
    UserEditorComponent.prototype.ngOnInit = function () {
        ...
        this.routerSubscription = this.route.params.subscribe(function (params) {
            ...
            if (id) {
                ...
                _this.userSubscription = _this.userService.get(id).subscribe(function (user) { return _this.user = user; });
            }
            else {
                _this.isAddingNew = true;
            }
        });
        this.userService.getToken().subscribe(function (t) { return _this.userToken = t; });
    };
    ...
    UserEditorComponent.prototype.regenerateToken = function () {
        var _this = this;
        this.userService.getToken(true).subscribe(function (t) {
            _this.userToken = t;
            _this.toasterService.pop('success', 'Token Regenerated');
        });
    };
    UserEditorComponent.prototype.submit = function () {
        var _this = this;
        if (this.isAddingNew) {
    ...
    UserEditorComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] },
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getToken = function (regenerate) {
